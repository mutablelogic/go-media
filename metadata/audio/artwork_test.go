...
const (
	testDir              = "../../etc/test"
	testFileArtwork      = "sample_with_artwork.mp3"
	testFileMultiArtwork = "sample_with_multi_artwork.mp3"
	testFileNoArtwork    = "sample.mp3"
)
...
func Test_artwork_002(t *testing.T) {
	for _, namespace := range []string{"", "dc", "audio"} {
