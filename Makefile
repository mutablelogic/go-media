...
ffmpeg-dep:
	...
	$(eval FFMPEG_CONFIG := $(FFMPEG_CONFIG) $(shell ${PKG_CONFIG} --exists gnutls && echo "--enable-gnutls"))
	...
	$(eval FFMPEG_CONFIG := $(FFMPEG_CONFIG) $(shell ${PKG_CONFIG} --exists gmp && echo "--enable-gmp"))
